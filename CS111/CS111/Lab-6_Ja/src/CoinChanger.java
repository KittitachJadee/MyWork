...
public class CoinChanger {
	...
	public boolean isValidType() {
		if(coin_1.getType()!=Coin.COIN1&&coin_2.getType()!=Coin.COIN1&&coin_3.getType()!=Coin.COIN1)
			return false;
		if(coin_1.getType()!=Coin.COIN1&&coin_1.getType()!=Coin.COIN5&&
		    coin_1.getType()!=Coin.COIN10&&coin_1.getType()!=Coin.COIN25&&
		    coin_1.getType()!=Coin.COIN100) {
			if(coin_2.getType()!=Coin.COIN1&&coin_2.getType()!=Coin.COIN5&&
				coin_2.getType()!=Coin.COIN10&&coin_2.getType()!=Coin.COIN25&&
				coin_2.getType()!=Coin.COIN100) {
				if(coin_3.getType()!=Coin.COIN1&&coin_3.getType()!=Coin.COIN5&&
					coin_3.getType()!=Coin.COIN10&&coin_3.getType()!=Coin.COIN25&&
